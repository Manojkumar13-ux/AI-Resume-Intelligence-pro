        ...
        {!isAuthPage && (
          <nav className="bg-white border-b border-slate-200/60 sticky top-0 z-50 px-4 md:px-6 py-3">
            <div className="max-w-7xl mx-auto flex items-center justify-between">
              <Link to="/dashboard" className="flex items-center gap-2 text-2xl font-extrabold text-indigo-600">
                <span>🧠</span> ResumeAI
              </Link>
              ...
              <div className="flex items-center gap-6">
                ...
                <Link to="/" className="text-sm font-medium bg-indigo-600 text-white px-4 py-2 rounded-full hover:bg-indigo-700 transition-colors">
                  Sign In
                </Link>
              </div>
            </div>
